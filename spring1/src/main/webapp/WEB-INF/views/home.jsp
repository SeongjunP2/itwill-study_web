...
<body>
    <header>
        <h1>Home</h1>
        <h2>${now}</h2>
        <!-- <img alt="파리" src="/spring1/images/paris.jpg">  -->
        <!-- <img alt="파리" src="./images/paris.jpg" />  -->
        <c:url var="paris" value="/images/paris.jpg" />
        <img alt="파리" src="${paris}" />
        <!-- <img src="http://localhost:8080/spring1/images/paris.jpg" />  -->
    </header>
