...
for (let x of numbers) {
    if (x % 2) { // 자바스크립트에서는 0은 false, 0이 아닌 숫자들은 true로 인식한다.(그러므로 x % 2 == 1이 불필요) 
